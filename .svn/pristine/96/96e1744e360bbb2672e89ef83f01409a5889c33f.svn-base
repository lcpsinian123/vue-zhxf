 ...
 * @LastEditTime: 2019-11-13 09:25:48
...
axios.interceptors.request.use(
  ...
  // config => {
  //   // hasCookie是自定义的参数 用于识别该请求是否需要带cookie
  //   if (config.params && config.params.hasOwnProperty('hasCookie')) {
  //     axios.defaults.withCredentials = true
  //     delete config.params.hasCookie
  //   } else {
