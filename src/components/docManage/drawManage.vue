<template>
  <div class="containers cententpadding">
    ...
    <div class="rightHead" style="width:100%">
        <div class="sousuo1">
          <div class="searchMeun">
            <span style="width:100px;text-align:right;">图纸名称：</span>
            ...
            <DatePicker
              ...
              placeholder="开始时间"
              style="width: 12%"
              @on-change="drawCategory.startTime=$event"
            ></DatePicker>
               — 
            <DatePicker
              ...
              placeholder="结束时间"
              style="width: 12%"
              @on-change="drawCategory.endTime=$event"
            ></DatePicker>
       ...
       <Modal width="700" v-model="addFlag" title="添加图纸" @on-ok="getAdd" @on-cancel="qx">
            ...
            <div class="addDraw">
              ...
              <DatePicker
                ...
                @on-change="floorNumVal.createDate=$event"
                format="yyyy-MM-dd HH:mm:ss"
                type="date"
                placeholder="请输入日期"
                style="width: 230px"
            ...
            <div class="addDraw">
              ...
              <DatePicker
                ...
                @on-change="WordName.createDate=$event"
                format="yyyy-MM-dd HH:mm:ss"
                type="date"
                placeholder="请输入日期"
                style="width: 230px"
        ...
        <div class="tableBox">
              <div class="btnclass">
          <Button type="primary" @click="addFlagj()" ghost>添加</Button>
...
export default {
  ...
  this.fireBase=res[0].fireBase;
    ...
    remove(index) {
          let glist = null
            this.$axios.post('/syspower/fireMdBase/getListAll?guid=' + index.guid).then(res => {
